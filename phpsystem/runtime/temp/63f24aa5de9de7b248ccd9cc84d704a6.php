...
<div class="container">
    ...
    <div class="row bottom15">
        ...
        <div class="col-md-10 col-xs-6"><?php echo $bookType['bookTypeId']; ?></div>
    </div>
    <div class="row bottom15">
        <div class="col-md-2 col-xs-4 text-right bold">类别名称:</div>
        <div class="col-md-10 col-xs-6"><?php echo $bookType['bookTypeName']; ?></div>
    </div>
    <div class="row bottom15">
        <div class="col-md-2 col-xs-4 text-right bold">可借阅天数:</div>
        <div class="col-md-10 col-xs-6"><?php echo $bookType['days']; ?></div>
    </div>
    <div class="row bottom15">
