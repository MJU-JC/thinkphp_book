...
<script>
    ...
    <div class="container">
        <ul class="breadcrumb">
            <li><a href="__PUBLIC__/index.php">首页</a></li>
            <li><a href="<?php echo url('Book/frontlist'); ?>">图书信息</a></li>
            <li class="active">详情查看</li>
        </ul>
        <div class="row bottom15">
            <div class="col-md-2 col-xs-4 text-right bold">图书条形码:</div>
            <div class="col-md-10 col-xs-6"><?php echo $book['barcode']; ?></div>
        </div>
        <div class="row bottom15">
            <div class="col-md-2 col-xs-4 text-right bold">图书名称:</div>
            <div class="col-md-10 col-xs-6"><?php echo $book['bookName']; ?></div>
        </div>
        <div class="row bottom15">
            <div class="col-md-2 col-xs-4 text-right bold">图书所在类别:</div>
            <div class="col-md-10 col-xs-6"><?php echo $book['bookTypeObjF']['bookTypeName']; ?></div>
        </div>
        <div class="row bottom15">
            <div class="col-md-2 col-xs-4 text-right bold">图书价格:</div>
            <div class="col-md-10 col-xs-6"><?php echo $book['price']; ?></div>
        </div>
        <div class="row bottom15">
            <div class="col-md-2 col-xs-4 text-right bold">库存:</div>
            <div class="col-md-10 col-xs-6"><?php echo $book['count']; ?></div>
        </div>
        <div class="row bottom15">
            <div class="col-md-2 col-xs-4 text-right bold">出版日期:</div>
            <div class="col-md-10 col-xs-6"><?php echo $book['publishDate']; ?></div>
        </div>
        <div class="row bottom15">
            <div class="col-md-2 col-xs-4 text-right bold">出版社:</div>
            <div class="col-md-10 col-xs-6"><?php echo $book['publish']; ?></div>
        </div>
        <div class="row bottom15">
            <div class="col-md-2 col-xs-4 text-right bold">图书图片:</div>
            <div class="col-md-10 col-xs-6"><img class="img-responsive" src="__PUBLIC__/<?php echo $book['bookPhoto']; ?>"  border="0px"/></div>
        </div>
        <div class="row bottom15">
            <div class="col-md-2 col-xs-4 text-right bold">图书简介:</div>
            <div class="col-md-10 col-xs-6"><?php echo $book['bookDesc']; ?></div>
        </div>
        <div class="row bottom15">
            <div class="col-md-2 col-xs-4 text-right bold">图书文件:</div>
            <div class="col-md-10 col-xs-6"><a href="__PUBLIC__/<?php echo $book['bookFile']; ?>" target="_blank"><?php echo $book['bookFile']; ?></a></div>
        </div>
        <div class="row bottom15">
