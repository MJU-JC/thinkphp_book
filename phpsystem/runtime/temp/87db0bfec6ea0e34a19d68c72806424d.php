<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"C:\xampp\htdocs\phpsystem\public/../application/back\view\book\book_query.html";i:1538203905;}*/ ?>
...
<div id="book_manage_tool" style="padding:5px;">
    ...
    <div style="padding:0 0 0 7px;color:#333;">
        <form id="bookQueryForm" method="post">
            ...
            图书所在类别：<input class="textbox" type="text" id="bookTypeObj_bookTypeId_query" name="bookTypeObj_bookTypeId" style="width: auto"/>
    ...
    <form id="bookEditForm" enctype="multipart/form-data"  method="post">
        <div>
            ...
            <span class="inputControl">
				<input class="textbox" type="text" id="book_barcode_edit" name="book_barcode" style="width:200px" />
			</span>
        </div>
        <div>
        ...
        <div>
            ...
            <span class="inputControl">
                ...
                <script type="text/javascript" src="__PUBLIC__/backjs/book/book_manage.js"></script>
